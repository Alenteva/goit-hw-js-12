import{S as w,a as d,i as p}from"./assets/vendor-b42c18af.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))u(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&u(i)}).observe(document,{childList:!0,subtree:!0});function c(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function u(r){if(r.ep)return;r.ep=!0;const o=c(r);fetch(r.href,o)}})();const L=new w(".gallery a",{captionsData:"alt",captionPosition:"bottom",captionDelay:250}),S=document.querySelector("form"),y=document.querySelector(".gallery"),n=document.querySelector(".loader"),a=document.querySelector(".btn");let l,s=1,f=15,h;S.addEventListener("submit",async function(t){if(t.preventDefault(),l=t.target.elements.search.value,l!==""){s=1,y.innerHTML="",n.style.display="block";try{const e=await m(l);g(e.hits),h=Math.ceil(e.totalHits/f),s+=1,b(),k()}catch(e){console.error(e)}finally{n.style.display="none"}t.target.reset()}});async function m(t){try{const e=new URLSearchParams({key:"42245077-d2f8998b656235f8798291f32",q:`${t}`,image_type:"photo",orientation:"horizontal",safesearch:"true",page:`${s}`,per_page:`${f}`});return d.defaults.baseURL="https://pixabay.com",(await d.get(`/api/?${e}`)).data}catch(e){console.error(e)}finally{n.style.display="none"}}function $(t){return t.map(e=>`<li class="gallery-item">
